				...
				<tbody>
					...
					<tr class="">
						...
						<td>
							...
							<?php if( $_GET['navigation'] == 'add-post-type' ): ?>
								<input type="hidden" class="permissionSetCustomValues" />
							<?php endif; ?>
											...
											<tr class="">
												...
												<td>
													<select name="advanced[capability]<?php echo '['.$caps_list_key.']'; ?>" id="<?php echo 'permission_'.$caps_list_key; ?>">
														<?php foreach ( $wp_roles->roles['administrator']['capabilities'] as $cap => $name ):
					...
					<tr class="">
						...
						<td>
							...
							<?php if( $_GET['navigation'] == 'add-post-type' ): ?>
										<input type="hidden" class="rewriteSetCustomValues" />
							<?php endif; ?>
					...
					<tr class="">
						...
						<td>
							...
							<?php if( $_GET['navigation'] == 'add-post-type' ): ?>
								<input type="hidden" class="querySetCustomValues" />
							<?php endif; ?>
...
<input class="button-primary" type="button" id="save-button-post-type" value="<?php _e( 'Save Settings', 'runway' ) ?>">
</form>
