...
<table class="wp-list-table widefat" style="width: auto; min-width: 50%;">
	<thead>
		<tr>
			<th id="field-name" class="manage-column column-name"><?php _e( 'Field', 'runway' ) ?></th>
	...
	<tbody id="the-list">
		<?php if( ! empty( $content_types_admin->content_types_options['fields'] ) ) :
						...
						if( isset( $values['inputs'] ) ) {	?>
							<tr class="active">
								...
								<td class="column-actions">
									<a href="<?php echo $this->self_url( 'add-inputs' ); ?>&alias=<?php echo $values['alias']; ?>"><?php echo __( 'Manage Inputs', 'runway' ); ?></a> |
									<a href="<?php echo $this->self_url( 'edit-field' ); ?>&alias=<?php echo $values['alias']; ?>"><?php echo __( 'Edit', 'runway' ); ?></a> |
									<a href="<?php echo $this->self_url( 'confirm-delete-field' ); ?>&alias=<?php echo $values['alias']; ?>"><?php echo __( 'Delete', 'runway' ); ?></a>
								</td>
							</tr>
						<?php }  ?>
					<?php endforeach; ?>
			<?php else : ?>
					<tr class="active">
						<td class="no-items" colspan="2">
							<?php echo __( 'No custom fields to display it\'s here', 'runway' ); ?>
						</td>
					</tr>
			<?php endif;  ?>
	</tbody>
